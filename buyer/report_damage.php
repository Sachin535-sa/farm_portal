    ...
    <div class="reporting-container">
        <div class="glass-card animate-slide" style="padding: 32px; background: rgba(255,255,255,0.95);">
            <div style="margin-bottom: 24px;">
                <span style="font-size: 11px; text-transform: uppercase; font-weight: 800; letter-spacing: 1px; color: #ef4444; background: rgba(239, 68, 68, 0.08); padding: 4px 10px; border-radius: 50px; display: inline-block; margin-bottom: 10px;">⚠️ Automated Claim Verification</span>
            ...
            <?php if (!empty($order['original_parcel_image'])): ?>
                <div style="background: rgba(16, 185, 129, 0.04); border: 1px dashed rgba(16, 185, 129, 0.3); border-radius: var(--radius-md); padding: 14px; margin-bottom: 24px; display: flex; align-items: center; gap: 12px;">
                    ...
                    <div>
                        <h4 style="color: var(--secondary); font-size: 12px; margin: 0; text-transform: uppercase;">🛡️ Reference Image Captured</h4>
            ...
            <form action="process_complaint.php" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: flex; gap: 14px; margin-top: 24px;">
                    <a href="my_orders.php" class="btn btn-secondary" style="flex: 1; text-align: center;">Cancel</a>
                    <button type="submit" class="btn btn-danger" style="flex: 2; justify-content: center; background: linear-gradient(135deg, #ef4444 0%, #b91c1c 100%); border: none;">
                        Submit Claim 🚨
                    </button>
                </div>
            </form>
